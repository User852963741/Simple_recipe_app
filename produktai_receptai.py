...
class Pagrindinis:
    def __init__(self, langas):
        ...
        self.istrintiprodukta = Button(langas, text="Istrinti turima produkta", command=self.trinuprod)
        self.istrintirecepta = Button(langas, text="Istrinti turima recepta", command=self.trinurec)
